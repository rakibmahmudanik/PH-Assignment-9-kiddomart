...
const Card = ({ toy }) => {
  ...
  return (
    <div data-aos="fade-up" data-aos-delay="100" className="">
      <div className="card h-full bg-base-100 shadow-md border border-base-200 hover:shadow-[#625fff97] hover:border-[#625fff43] hover:-translate-y-1.5  transition-all duration-500 ease-in-out">
